...
\node[fancytitle,right=5pt] at (box.north west) {{\large Exercice \arabic{i}}};
\ifEX@exo@bareme
\node[fancytitle] at (box.north){ \cmdEX@exo@bar {}points };
\fi
\end{tikzpicture}%
\stepcounter{i}
}
...
\node [draw,shape=chamfered rectangle] (box1){%
    \begin{minipage}{0.2\textwidth}
      \center La date :  \cmdEX@devoir@date 
    \end{minipage}
};
\end{tikzpicture}%
\begin{tikzpicture}
\node [draw,shape=chamfered rectangle] (box2){%
    \begin{minipage}{0.4\textwidth}
       \center Devoir surveillez de Mathématiques numéro :\cmdEX@devoir@num 
    \end{minipage}
};
\end{tikzpicture}%
\begin{tikzpicture}
\node [draw,shape=chamfered rectangle] (box3){%
    \begin{minipage}{0.2\textwidth}
 \center  le niveau : \cmdEX@devoir@niv      
    \end{minipage}
};
\end{tikzpicture}%
}
