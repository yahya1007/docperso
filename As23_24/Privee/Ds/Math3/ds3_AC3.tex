...
\begin{enumerate}
\begin{multicols}{2}
\item\brm{1} Calculer $sin\widehat{B}$\newline
\anserline[6]
\columnbreak
\item\brm[0.5]{1} Calculer  $tan\widehat{B}$ \newline
\anserline[6]
\end{multicols}%
\begin{multicols}{2}
\item\brm{2} Calculer  $BC$ \newline
\anserline[5]
\columnbreak
\item\brm[0.5]{2} Calculer $AC$ \newline
\anserline[5]
\end{multicols}%
\item\brm{2} Calculer les rapports trigonométriques de l'angle.$\widehat{C}$.\newline
\anserline[5]
\end{enumerate}
\end{exercice}
...
%$A=2cos15^{\circ}+cos^{2}36^{\circ}-2sin75^{\circ}+cos^{2}54^{\circ}=$\anserline[3]
