...
\item\brm{2} Comparer $a$ et $\dfrac{a+b}{2}$ 
\end{minipage}%
\begin{minipage}{.5\linewidth}
\item\brm{2} Comparer $3\sqrt{8}$ et $\sqrt{73}$ 
\end{minipage}
\end{enumerate}
\begin{minipage}{.5\linewidth}
\notes[10pt]{7}{.9\linewidth}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\notes[10pt]{7}{.9\linewidth}
\end{minipage}
...
\begin{enumerate}
\item\brm{4} Montrer que : $AN=6$ puis calculer $NC$ .
\item\brm{4} On considère $E$ un point de $[MA)$ et $F$ un point de $[NA)$ tel que : $AE=4$ et $AF=2$
