...
\item \pts{1} \underline{\hspace{1in}} jjjl

\item \pts{1} \underline{\hspace{1in}} $n / x + m$

\item \pts{1} \underline{\hspace{1in}} $int(x) / n + m$

\item \pts{1} \underline{\hspace{1in}} $n / (int)x + m$

\item \pts{1} \underline{\hspace{1in}} $int(y) % m$
